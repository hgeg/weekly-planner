(function() {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['zepto', 'vex'], vexDialogFactory);
  } else if (typeof exports === 'object') {
    module.exports = vexDialogFactory(require('zepto'), require('./vex.js'));
  } else {
    window.vex.dialog = vexDialogFactory(window.Zepto, window.vex);
  }
